...
interface PageProps {
    params: { topic: string },
    // searchParams: { [key: string], string | string[] | underfined },
...
export default async function Page ({params: {topic}} : PageProps) {
    ...
    return (
        <div>
            <Alert>
                    This page uses <strong> generatedStaticParams </strong>
                    to render abd cache static pages at build time, even though
